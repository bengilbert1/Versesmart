...
-- ai_cache: server-only cache accessed via service_role. Add an explicit
-- deny-all policy so RLS lint is satisfied and intent is documented.
CREATE POLICY "Deny all client access to ai_cache"
